...
fn deserialize_bytes() {
    ...
    let attribute_value = AttributeValue::M(HashMap::from([(
        String::from("value"),
        AttributeValue::B(aws_sdk_dynamodb::types::Blob::new(vec![
...
fn deserialize_byte_arrays() {
    ...
    let attribute_value = AttributeValue::M(HashMap::from([(
        ...
        AttributeValue::Bs(vec![
            aws_sdk_dynamodb::types::Blob::new(vec![116, 101, 115, 116, 0, 0, 0, 0]),
            aws_sdk_dynamodb::types::Blob::new(vec![2]),
            aws_sdk_dynamodb::types::Blob::new(vec![0, 0, 0, 0]),
        ]),
    )]));
