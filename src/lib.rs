...
//! ```toml
//! [dependencies]
//! serde_dynamo = { version = "3", features = ["aws-sdk-dynamodb+0_17"] }
//! ```
//!
//! See [`aws_sdk_dynamodb_0_17`] for examples and more information. See
//! [`aws_sdk_dynamodbstreams_0_17`] for DynamoDb streams support.
//!
